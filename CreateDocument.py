...
def createDocument(project_number: str, location: str, user_id: str , schemaId:str) -> None:

    document_schema = GetSchemaById.get_document_schema_by_id(project_number , location , schemaId)
